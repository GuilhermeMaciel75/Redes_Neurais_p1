...
The code originally relied on Theano but unfortunately it isn't
compatible with anything past Python 3.9. We ended up porting it to
Aesara because it offers similar functionality and performance. Also
its interface is very close to Theano's, which makes the transition
seamless.
...
class FullyConnectedLayer(object):
    ...
    def set_inpt(self, inpt, inpt_dropout, mini_batch_size):
        ...
        self.inpt_dropout = dropout_layer(
            T.reshape(inpt_dropout, (mini_batch_size, self.n_in)), self.p_dropout)
